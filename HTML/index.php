...
<head>
    ...
    <meta name="description" content="Rent my Car website" />
    <meta name="keywords" content="personal, homepage, HTML" />
...
<body>
    ...
    $sql = "SELECT * FROM vehicle_details ORDER BY year DESC LIMIT 5;"; 
